...
export const ForYourBusiness: React.FC = () => {
  return (
    <div className="flex justify-between max-[1000px]:flex-col-reverse items-center mt-[5rem] mb-[5rem]">
      <div className="w-full">
        <h5 className="uppercase text-primary-600 tracking-widest mb-5">
          para o seu negócio
        </h5>

        <div className="text-start w-full min-[1000px]:max-w-[32rem]">
          <h2 className="font-bold text-[2.5rem]  mb-[1.25rem]">
            Mais visibilidade
          </h2>

          <p className="text-primary-900 text-[1.25rem] mb-[2.93rem]">
            Faça seu negócio decolar marcando presença online com um site que é
