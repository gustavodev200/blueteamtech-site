  ...
  return (
    ...
    >
      ...
      <img
        ...
        width={114}
        height={50}
        className="max-[730px]:hidden cursor-pointer"
        onClick={() => {
          scrollToAnchor("#home");
        }}
      />
      ...
      <button
        ...
        className="max-[600px]:w-full text-white text-sm font-black py-3 px-8 rounded uppercase border border-white/30 hover:bg-white hover:text-primary-900 transition-colors duration-200 ease-in-out"
      >
        contato
      </button>
    </nav>
